...
public class Main {
	private static final String RESET_Q= """
			ALTER TABLE storefront
			DELETE FROM storefront.order AUTO_INCREMENT=1
			DELETE FROM storefront.order_details AUTO_INCREMENT=1;
			""";
	...
	public static void main(String[] args) {
		...
		try (Connection conn = dataSource.getConnection()) {
			...
			DateTimeFormatter dtf = DateTimeFormatter.ofPattern("G yyyy-MM-dd HH:mm:ss")
					.withResolverStyle(ResolverStyle.STRICT);
//
//			callOrder.registerOutParameter(1, Types.INTEGER);
//			callOrder.registerOutParameter(2, Types.INTEGER);
			orders.forEach(o->{
